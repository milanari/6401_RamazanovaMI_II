...
class KNearestNeighbor(object):
    ...
    def compute_distances_two_loops(self, X):
        ...
        for i in range(num_test):
            for j in range(num_train):
                ...
                # Вычисляем евклидово расстояние (L2) между двумя точками
                # sqrt(sum((x_i - x_train_j)^2))
    ...
    def compute_distances_one_loop(self, X):
        ...
        for i in range(num_test):
            ...
            # Вычисляем расстояния между тестовой точкой i и всеми обучающими точками
            # вычитаем вектор X[i] из каждой строки self.X_train
    ...
    def predict_labels(self, dists, k=1):
        ...
        for i in range(num_test):
            ...
            # Находим индексы k ближайших соседей (сортируем по расстоянию)
