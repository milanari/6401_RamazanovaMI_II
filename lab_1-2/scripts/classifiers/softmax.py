...
def softmax_loss_naive(W, X, y, reg):
    ...
    for i in range(num_train):
        # Вычисляем scores для i-го примера
        scores = X[i].dot(W)  
...
def softmax_loss_vectorized(W, X, y, reg):
    ...
    # Вычисляем scores для всех примеров сразу
    scores = X.dot(W)  # (N, C)
    
    # Для численной стабильности вычитаем максимальное значение для каждого примера
